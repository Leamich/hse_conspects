1. $\mathscr{A}$ — [[hse/ma/conspects/sem03/01. Теория меры/01. Системы множеств/Алгебра|Алгебра]] и $A_{1},\dots,A_{n} \in \mathscr{A}$, то $\bigcap\limits_{k=1}^{n}A_{k}$ и $\bigcup\limits_{k=1}^{n}A_{k}\in \mathscr{A}$
